#  Navegación Autónoma con A* en Webots

Este proyecto implementa un robot móvil que navega de forma autónoma en una arena de 4×4 metros utilizando sensores LIDAR, GPS y ultrasónicos. La planificación de ruta se realiza con el algoritmo A*, y el robot evita obstáculos en tiempo real mientras detecta y registra los giros realizados.
...
- `worlds/`: archivo `.wbt` del entorno de simulación en Webots.
- `README.md`: este documento.
- `Simulacion/`: carpeta base del proyecto para importar en Webots.

---

## ▶ Compilar y Ejecutar en Webots

1. Abre **Webots** y selecciona **Open Project**.
2. Navega a la carpeta del proyecto descargado.
3. Abre el archivo `.wbt` ubicado en `Simulacion/worlds/`.
4. Asegúrate de que el controlador esté correctamente asignado al robot.
5. Webots compilará automáticamente los archivos C al iniciar la simulación.
6. Presiona el botón **Play** para comenzar la ejecución.

---

##  Recursos

- [ Vídeo de la Simulación](https://drive.google.com/file/d/1XITdGnRunCSLue8RFlT3_ublmffu67Tq/view?usp=sharing)  
- [ Informe Técnico](https://docs.google.com/document/d/1M_IBK2rSPnfvQ1v3JoH0SXQmx45bcGHrqUmqta3y37I/edit?usp=sharing)

---

##  Comportamiento del Robot

- Construye un **mapa binario del entorno** usando LIDAR y GPS.
- Planifica una ruta hacia la esquina inferior izquierda con **A\***.
- Evita obstáculos detectados en tiempo real.
- Detecta y registra automáticamente **giros a izquierda y derecha**.
- Se detiene al alcanzar una **zona objetivo** definida por coordenadas GPS.
